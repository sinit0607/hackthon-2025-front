...
class ParallaxFlowDelegateForHorizontal extends FlowDelegate {
  ParallaxFlowDelegateForHorizontal({
  ...
  void paintChildren(FlowPaintingContext context) {
    ...
    final scrollFraction =
        (listItemOffset.dx / viewportDimension).clamp(0.0, 2.0);
  ...
  @override
  bool shouldRepaint(ParallaxFlowDelegateForHorizontal oldDelegate) {
